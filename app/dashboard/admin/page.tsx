    ...
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Connect your QuickBooks account to enable payment processing for all
            users. This is a one-time setup that allows the application to
            ...
            <CardHeader>
              <div className="w-full flex justify-between items-end flex-wrap gap-y-5">
                <div>
                  ...
                  <CardDescription>
                    View and manage all book and card orders
                  </CardDescription>
                </div>
